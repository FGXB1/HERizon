export class AudioEngine {
  ...
  // Effect States
  private isReverbOn = false;
  private isDelayOn = false;
  private isDistortionOn = false;
  ...
  // Tracks
  private tracks: Record<string, boolean[]> = {
