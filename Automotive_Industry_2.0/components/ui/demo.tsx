...
const ProceduralGroundBackground: React.FC<ProceduralGroundBackgroundProps> = ({ className }) => {
  ...
  return (
    <div className={cn("pointer-events-none fixed inset-0 -z-10 h-full w-full bg-zinc-950", className)}>
      <canvas ref={canvasRef} className="block h-full w-full touch-none" style={{ filter: "contrast(1.1) brightness(0.9)" }} />
    </div>
  );
};
