...
export function RhythmCoach({ step, tracks, reverbMix, onNext, onClose, onStart, onRestart, children }: RhythmCoachProps) {
  ...
  return (
    <AnimatePresence mode="wait">
      {/* Minimized State - Now shows Opportunities */}
      {isMinimized && (
        <motion.div
          key="minimized-opportunities"
